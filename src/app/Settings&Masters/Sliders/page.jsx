...
import AddNewImage from "./AddNewImage/page";
        ...
        <Box sx={{ borderBottom: 1, borderColor: "divider", width: "100%" }}>
          {isMobileTab ? (
            <Select
              ...
              displayEmpty
            >
              <MenuItem value={0}> Slider Images</MenuItem>
              <MenuItem value={1}> Add New Image</MenuItem>
            </Select>
          ) : (
            <Tabs
              value={value}
            ...
            >
              <Tab label=" Slider Images" />
              <Tab label="Add New Image" />
            </Tabs>
          )}
        </Box>
            ...
            <div className="grid gap-4 mt-5">
              {displayedRows.map((row, index) => (
                ...
                >
                  ...
                  <p>
                    <strong>Slider Image:</strong> {row.RoleName}
                  </p>
                  <p>
                    <strong> Description:</strong> {row.Status}
                  </p>
                  <p>
                    <strong>Language:</strong> {row.Permissions}
                  </p>
